...
<thead>
	...
	<tr>
		<td>
			<a href="<?php echo e(route('reviewsForSite', $p->site->url)); ?>">
				<?php echo e($p->site->business_name); ?><br>
				<small><?php echo e($p->site->url); ?></small>
			</a>
		</td>
		<td>
...
<?php echo $__env->make( 'base' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/crivion/Sites/trusted-reviews/resources/views/account/my-reviews.blade.php ENDPATH**/ ?>