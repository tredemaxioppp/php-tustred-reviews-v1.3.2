...
<form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;"><?php echo csrf_field(); ?></form><?php /**PATH /Users/crivion/Sites/trusted-reviews/resources/views/partials/navi.blade.php ENDPATH**/ ?>