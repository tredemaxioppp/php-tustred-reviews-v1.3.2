    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <?php echo e(__('Six Months')); ?></h3>
                </div>
                <div class="panel-body">
                    <div class="the-price">
                        <h1>
                            <?php echo e(Options::get_option('currency_symbol')); ?><?php echo e(Options::get_option( '6monthsPrice' )); ?><span class="subscript">/<?php echo e(__('six mo')); ?></span></h1>
                    </div>
                    <table class="table">
                        <tr>
                            <td>
                ...
                <div class="panel-footer">
                    <?php if( request()->has( 'company' ) ): ?>
                        <a href="<?php echo e(route('companyClaim', [ 'site' => request()->company, 'plan' => '6months' ])); ?>" class="btn btn-success"><?php echo e(__( 'Select 6 Months Plan' )); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php echo $__env->make( 'base' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/crivion/Sites/reviews/resources/views/companies-plans.blade.php ENDPATH**/ ?>