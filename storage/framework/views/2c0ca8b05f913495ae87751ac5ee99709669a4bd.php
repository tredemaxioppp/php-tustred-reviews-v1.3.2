  ...
  <div class="row">
    ...
    <div class="col-md-6 col-9 col-md-6 no-padding">
      ...
      <div class="col-md-1 col-2 no-padding">
          <input type="submit" name="searchAction" class="btn btn-warning" value="<?php echo e(__('Go')); ?>">
      </div><!-- /.col-md-1 no-padding -->
    </div><!-- /.row -->
  </form>
</div>
</div><!-- /.container-fluid -->
<br/><?php /**PATH /Users/crivion/Sites/trusted-reviews/resources/views/partials/inner-header.blade.php ENDPATH**/ ?>